    ...
    <Table responsive className="text-center padding-4">
      ...
      <tbody>
        <tr>
            <td>
                <div className="table__has-img">
                    <div className="img-box">
                        <img src="/assets/images/Avatar.png" alt="user" className="img-fluid" />
                    </div>
                    XYZ VC
                </div>
            </td>
            <td><span className="text-secondary">FinTech, Saas, EdTech</span></td>
            <td>
            ...
            <td><span className="badge dark-badge">Globally</span></td>
            <td>ABCD</td>
            <td><Form.Check type="switch" /></td>
            <td><button type="button" className="sm_app-btn sm_app-btn-secondary">Apply</button></td>
        </tr>
        <tr>
            <td>
                <div className="table__has-img">
        ...
        <tr>
            ...
            <td><span className="badge dark-badge">Globally</span></td>
            <td>ABCD</td>
            <td><Form.Check type="switch" checked /></td>
            <td><button type="button" className="sm_app-btn sm_app-btn-secondary">Apply</button></td>
        </tr>
        <tr>
            <td>
